...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "ucLf3RhHEaePTkTRirwoHEeT";
    public static String secretKey = "teVWhyz4ehdt7ze93WHDiTKGPGWPvca9";
    public static String licenseID = "com-link-cloud-face-android";
     ...
     */
    public static String groupID = "com_link_cloud";
